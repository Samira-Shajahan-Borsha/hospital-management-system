          ...
          <div class="container">
            ...
            <div class="row pt-5 pb-5 ">
              ...
              <div class="col-12 text-center align-items-center"  >
                  <button name="nxt_btn" class="btn btn-primary btn-lg" type="submit" id="nxt_btn"> Next </button>  <button name="bck_btn" class="btn btn-primary btn-lg" type="submit" > Back </button>
            </div>
            </div>
...
// });
    ...
    //   ajax.open("GET","test_ajax_4.php?q=123",true);
    //   ajax.send();
...
//     }
//   };
//   xhttp.open("GET", "test_ajax_4.php", true);
//   xhttp.send();
// }


  // document.getElementById('nxt_btn').addEventListener('click',loadResponse);
