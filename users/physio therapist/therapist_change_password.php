...
<html lang="en">
  ...
  <script>
    var my_form = document.forms.Form2;

  			my_form.onsubmit = function(){
  				var f_name_val = my_form.opwd.value;
  				var l_name_val = my_form.npwd.value;
          var c_name_val = my_form.cpwd.value


  				if(f_name_val == "" || l_name_val == "" || c_name_val == "") {
