<?php
 ...
 $uspec = $degree = $msg = "" ;
    ...
    if(isset($_POST['edit_btn'])) {
        ...
        mysqli_query($conn,"UPDATE doctor_info set fullname='" . $_POST['fname'] . "', blood_group='" . $_POST['blood_group'] . "', gender='" . $_POST['gender'] . "' ,email='" . $_POST['email'] . "',phone='" . $_POST['phone'] . "',dob='" . $_POST['dob'] . "',address='" . $_POST['address'] . "'  WHERE userid='$uid'");
